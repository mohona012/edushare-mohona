...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        InitializeFields();
        RetrieveUserInfo();
        Toast.makeText(this, "Yesy", Toast.LENGTH_SHORT).show();
    ...
    private void InitializeFields()
    {
        ...
        SettingsToolBar = (Toolbar) findViewById(R.id.simplePageToolBar);
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            final String downloaedUrl = filePath.getDownloadUrl().toString();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if ((dataSnapshot.exists()) && (dataSnapshot.hasChild("name") && (dataSnapshot.hasChild("picture")))) {
                            ...
                            String retrieveProfileImage = dataSnapshot.child("picture").getValue().toString();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.viewCoursesOption) {
            startActivity(new Intent(SettingsActivity.this, ClassListActivity.class));
            finish();
        }
        ...
        if(item.getItemId()==R.id.createClassOption) {
            startActivity(new Intent(SettingsActivity.this, CreateClassActivity.class));
            finish();
        }
        return true;
    }
